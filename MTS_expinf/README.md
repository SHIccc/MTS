...
Example :
- 'The model-implied three-year (red) and five-year(blue dashed) forecast of IE for 
each European country.'
- 'The comparison of estimated IE forecast across five different countries - U.K. (red), 
