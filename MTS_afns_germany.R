...
Meloading_joint = function(lambda, alphaS, alphaC, time = maturity) {
  ...
  row2 = c(0, alphaS * ((1 - exp(-lambda * time))/(lambda * time)), 
            alphaC * ((1 - exp(-lambda * time))/(lambda * time) - exp(-lambda * 
                                                                        time)), 1)
...
afnsss = function(t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, 
  ...
  Tt = matrix(c(t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, 
                 t14, t15, t16), nr = 4)
  Zt = rbind(Meloading_joint(lambda = l1, alphaS = g1, alphaC = g2, 
                              time = demat[1]), Meloading_joint(lambda = l1, alphaS = g1, alphaC = g2, 
                                                                time = demat[2]), Meloading_joint(lambda = l1, alphaS = g1, alphaC = g2, 
                                                                                                  time = demat[3]))
  ct = matrix(rep(c(yieldadj_joint(sigma11 = h1, sigma22 = h2, sigma33 = h3, 
                                    sigma44 = h4, lambda = l1, time = demat[1]), yieldadj_joint(sigma11 = h1, 
                                                                                                sigma22 = h2, sigma33 = h3, sigma44 = h4, lambda = l1, time = demat[2]), 
