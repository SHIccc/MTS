...
## ![qlogo](http://quantnet.wiwi.hu-berlin.de/graphics/quantlogo.png) **MTS_sfns_sw**
...
afnsss = function(t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, 
    ...
    Zt = rbind(Meloading_joint(lambda = l1, alphaS = g1, alphaC = g2, time = swmat[1]), 
        Meloading_joint(lambda = l1, alphaS = g1, alphaC = g2, time = swmat[2]), 
        Meloading_joint(lambda = l1, alphaS = g1, alphaC = g2, time = swmat[3]))
