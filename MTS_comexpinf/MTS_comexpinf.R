...
#              of IE dynamics. Graphic showing the common inflation factor 
#              and the model residuals.
# ------------------------------------------------------------------------------
# Keywords:    Kalman filter, estimation, filter, maximum likelihood, MLE, 
...
plot(ukts2, col = "grey", lwd = 2, ylim = c(-1, 4), ylab = NA, xlab = NA)
